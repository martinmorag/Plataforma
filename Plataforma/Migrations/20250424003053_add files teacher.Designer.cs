...
namespace Plataforma.Migrations
{
    ...
    [Migration("20250424003053_add files teacher")]
    partial class addfilesteacher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Plataforma.Models.Clase", b =>
                {
                    ...
                    b.Property<string>("ProfesorArchivoUrl")
                        .IsRequired()
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");

                    b.Property<string>("ProfesorFileName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ProfesorFileType")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<DateTime?>("ProfesorFileUploadDate")
            ...
            modelBuilder.Entity("Plataforma.Models.Tarea", b =>
                {
                    ...
                    b.Property<string>("RespuestaEstudianteArchivoUrl")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RespuestaEstudianteContentType")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<DateTime?>("RespuestaEstudianteFechaEntrega")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("RespuestaEstudianteFileName")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Plataforma.Models.Curso", b =>
                {
                    ...
                    b.HasOne("Plataforma.Models.Profesor", null)
                        .WithMany("CursosACargo")
